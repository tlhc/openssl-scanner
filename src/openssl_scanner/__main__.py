...
def _write_scan_report(result, reporter, matcher, output_path, elapsed,
                       json_only=False):
    """Write JSON report and print summary for scan/proc commands."""
...
def cmd_scan(args) -> int:
    ...
    try:
        ...
        _write_scan_report(result, reporter, matcher, args.output, elapsed,
...
from .hap_report import (
    PkgEntry as _PkgEntry,
    plan_packages as _plan_packages,
    extract_pkg_entry as _extract_pkg_entry,
    merge_hap_results as _merge_hap_results,
    resolve_hap_output_names as _resolve_hap_output_names,
    hap_write_single_report as _hap_write_single_report,
    collect_bundled_names as _collect_bundled_names,
